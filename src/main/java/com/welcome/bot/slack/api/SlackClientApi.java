...
public interface SlackClientApi {
	 ...
	 * @param text - New text that will replace previous message text,
	 * @param messageTimestamp - Time stamp of message (time at which message was posted)
	 * @throws SlackApiException - If something is wrong (arguments invalid, updating failed), exception will be thrown.
	 */
	 ...
	 * @param channel - Name of channel where message was posted,
	 * @param messageTimestamp - Time stamp of message (time at which message was posted).
	 * @throws SlackApiException - If something is wrong (arguments invalid, deleting failed), exception will be thrown.
	 */
